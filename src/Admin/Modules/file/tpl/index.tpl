...
<div class="files-buttons">
    ...
    <div class="import-btn-form">
        <form method="post" enctype="multipart/form-data" action="?sf_module_id=<?php echo $this->id ?>&action=upload" onsubmit="return Fieldile.onSubmit(this)">
            <input type="file" name="file" onchange="Fieldile.onAttach(this)" />
